...
**Architecture:** Next.js 14 App Router with tRPC for type-safe API, Clerk for auth, Drizzle ORM with Supabase PostgreSQL, Basiq for Australian bank feeds. Forest theme (green primary) with CSS variable theming system.

**Tech Stack:** Next.js 14, tRPC, Drizzle ORM, PostgreSQL (Supabase), Clerk, Basiq, Tailwind CSS, shadcn/ui

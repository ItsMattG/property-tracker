...
const standardCSP = [
  "default-src 'self'",
  "script-src 'self' 'unsafe-inline' https://js.stripe.com https://*.posthog.com https://challenges.cloudflare.com https://*.cloudflare.com https://va.vercel-scripts.com https://vercel.live",
